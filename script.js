                            ...
                            <div class="improvement-header">
                                ...
                                <div class="improvement-actions">
                                                <button class="upvote-btn" type="button" data-action="upvote" data-rec-id="${rec.id}" title="Upvote">
                                                    <img src="./assets/images/icons/icon-thumb-up.png" alt="Upvote" width="16" height="16" class="auth-icon-img" />
                                                </button>
                                                <button class="downvote-btn" type="button" data-action="downvote" data-rec-id="${rec.id}" title="Downvote">
                                                    <img src="./assets/images/icons/icon-thumb-down.png" alt="Downvote" width="16" height="16" class="auth-icon-img" />
                                                </button>
